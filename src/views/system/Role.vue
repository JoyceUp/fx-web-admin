<template>
	<section>
		...
		<el-table :data="tableData" v-loading="listLoading" stripe highlight-current-row >
			...
			<el-table-column prop="role" label="角色名称" width="300px" > </el-table-column>
			<el-table-column prop="desc" label="角色描述" width="300px"> </el-table-column>
			<el-table-column prop="resources" :formatter="ownResourceFormatter" label="拥有资源"  > </el-table-column>
			<el-table-column label="操作">
				<template slot-scope="scope">
					<el-button

							@click="showEditUser(scope.$index, scope.row)">编辑</el-button>
					<el-button
		...
		<el-dialog :title="dialogFormTitle" :visible.sync="dialogFormVisible" :before-close="resetForm">
			<el-form :model="role_form" :rules="rules" ref="role_form_ref">
				<el-form-item label="角色名称" prop="role" :label-width="formLabelWidth">
				...
				<el-form-item label="拥有资源" prop="permission" :label-width="formLabelWidth">
					<el-tree
							:data="tree_data"
							:props="defaultProps"
            ...
            return {
                ...
                rules: {                //表单过滤
					...
					desc:[
                        ...
                        {min: 0, max: 50, message: '长度在 50个字符以内', trigger: 'blur'}
					]
                },
