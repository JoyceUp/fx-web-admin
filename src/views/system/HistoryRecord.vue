<template>
    <section>
        ...
        <el-col :span="24" class="toolbar" style="padding-bottom: 0px;">
            <el-form :inline="true" :model="filters" ref="filters" size="medium">
                <el-form-item prop="system_key">
                    <el-select clearable placeholder="参数类型" v-model="filters.system_key">
                        <el-option :key="item.value" :label="item.key" :value="item.value" v-for="item in options" ></el-option>
                    </el-select>
                </el-form-item>
                <el-form-item prop="opt_id">
                    <el-input placeholder="手机号" v-model.trim="filters.opt_id"></el-input>
                </el-form-item>
                <el-form-item prop="opt_user_name">
                    <el-input placeholder="姓名" v-model.trim="filters.opt_user_name"></el-input>
                </el-form-item>
                <el-form-item prop="dataRange">
                    <div class="block">
                        <el-date-picker
                                :clearable="clearable"
                                v-model="filters.dataRange" type="daterange" start-placeholder="提交日期" end-placeholder="提交日期"
                                placeholder="选择时间范围" @change="handleDateChange"
        ...
        <el-table :data="items" stripe highlight-current-row >
            <!--<el-table-column type="index" label="编号" width="180px"> </el-table-column>-->
            <el-table-column prop="opt_id" label="手机号"> </el-table-column>
            <el-table-column prop="opt_user_name" label="姓名"></el-table-column>
            <el-table-column prop="gmt_create" label="提交时间" >
                <template slot-scope="scope">
                    <span>{{ fmtDate(scope.row.gmt_create) }}</span>
                </template>
            </el-table-column>
            <!--<el-table-column prop="mark" label="备注" > </el-table-column>-->
            <el-table-column prop="system_key" label="参数类型" :formatter="getSystemKey"></el-table-column>
            <el-table-column prop="system_value" label="参数值"></el-table-column>
        </el-table>
