<template>
    <section>
        ...
        <el-table :data="items" stripe style="width: 100%" tooltip-effect="dark">
            ...
            <el-table-column prop="customer_name" label="客户姓名" width="180"> </el-table-column>
        ...
        <el-dialog title="添加沟通记录" :visible.sync="dialogFormVisible" width="650px" @open="open('commForm')">
            <el-form :model="commForm" ref="commForm" :rules="formRules">
                ...
                <el-form-item>
                    <el-button @click="resetForm('commForm')" >取 消</el-button>
