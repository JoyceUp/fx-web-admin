<template>
    <section>
        ...
        <el-col :span="24" class="toolbar" style="padding-bottom: 0px; ">
            <el-form :inline="true" :model="filters" ref="filters"   size="medium">
                <el-form-item label="" prop="account_no">
                    <el-input placeholder="客户账号"  v-model.trim="filters.account_no">
                    </el-input>
                </el-form-item>
                <el-form-item label="" prop="full_name">
                    <el-input placeholder="客户姓名"  v-model.trim="filters.full_name">
                    </el-input>
                </el-form-item>
                ...
                <el-form-item label="" prop="ib_full_name">
                    <el-input placeholder="代理姓名"  v-model.trim="filters.ib_full_name">
                    </el-input>
                </el-form-item>
                ...
                <el-form-item>
                    <el-button type="primary" size="small"  @click="getCustomers">查询</el-button>
                </el-form-item>
                <el-form-item>
        ...
        <el-col :span="24" class="toolbar" >
            <el-button type="primary" size="small"  @click="proxyChange">更换代理</el-button>
            <el-button type="primary" size="small"  @click="saleChange">更换销售</el-button>
        </el-col>
        <!--客户列表-->
        <el-table
        ...
        <!--详细操作对话框-选择代理-->
        <el-dialog title="选择代理" fullscreen :visible.sync="dialogProxyVisible" @open="dialogProxyOpen">
        ...
        <el-dialog title="选择销售" fullscreen :visible.sync="dialogSaleVisible" @open="dialogSaleOpen">
            <customerSale :receiverCount="dialogSaleReceiverCount" :selectedCustomers="multipleSelection" v-on:closeDialog="dialogSaleInvisible"></customerSale>
        </el-dialog>
    </section>
</template>
        ...
        methods: {
            ...
            getCustomerListByFilter() {
                ...
                let condition = {
                    ...
                    ib_full_name: this.filters.ib_full_name,
