<template xmlns:el-col="http://www.w3.org/1999/html">
    <section>
        ...
        <el-table
            ...
            <el-table-column label="操作" width="90">
                <template slot-scope="scope">
                    <el-button size="mini"
                               @click="rebateToBalanceDetails(scope.row.id)">查看
                    </el-button>
                </template>
            </el-table-column>
        </el-table>
        ...
        <el-dialog :title="dialog.title" :visible.sync="dialog.dialogFormVisible" :before-close="resetDialogData">
            <el-tabs >
                <el-tab-pane label="返利转余额详情">
                    <span slot="label"><i class="el-icon-date"></i> 返利转余额详情</span>
                    <el-form :model="dialog.dialogData"  ref="userFormRef" :label-width="dialog.formLabelWidth" >
                        ...
                        <el-form-item label="操作前余额(USD)：" :label-width="dialog.formLabelWidth">
                        ...
                        <el-form-item label="操作后余额(USD)：" :label-width="dialog.formLabelWidth">
    ...
    export default {
        ...
        data() {
            return {
                ...
                statistics: {},     //统计
                options: {
                    status: dict.rebate_to_balance_status,
