            ...
            <el-form :inline="true" :model="filters" ref="filters" :rules="filters_rules">
                <el-form-item prop="start_end_date">
                    <div class="block">
                        <el-date-picker
                                :clearable="clearable"
                                v-model="filters.start_end_date" type="daterange" start-placeholder="提交时间"
        ...
        methods: {
            ...
            calculate() {
                this.$refs["filters"].validate((valid) => {
                    if (valid) {
                        let params = {
                            start_time: date.dateStart(this.filters.order_time_from),
                            end_time: date.dateEnd(this.filters.order_time_to)
                        };
