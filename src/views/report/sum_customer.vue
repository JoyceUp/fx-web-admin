    ...
    <section>
                ...
                <el-form-item prop="cause">
                    <el-select clearable placeholder="资金类型" v-model="filters.cause">
                        ...
                        <el-option :key="value" :label="key" :value="value"
                                   v-for="(key, value) in options.cause_type"></el-option>
                    </el-select>
                </el-form-item>
        ...
        <el-table
            ...
            <el-table-column
                    width="120"
                    prop="amount"
                    :formatter="cent2dollarWithProfix"
                    label="金额(USD)">
            </el-table-column>
            <el-table-column
                    prop="order_status"
    ...
    export default {
        ...
        data() {
            return {
                ...
                statistics: {},     //统计
                options: {
                    cause_type: dict.report_customer_sum_cause,
        ...
        methods: {
            ...
            //负号
            cent2dollarWithProfix(row, column) {
