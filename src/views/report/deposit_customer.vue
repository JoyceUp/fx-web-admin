<template xmlns:el-col="http://www.w3.org/1999/html">
    <section>
                ...
                <el-form-item prop="cause">
                    <el-select clearable placeholder="资金类型" v-model="filters.cause">
                        ...
                        <el-option :key="value" :label="key" :value="value"
                                   v-for="(key, value) in options.deposit_cause_type"></el-option>
                    </el-select>
                </el-form-item>
        ...
        <el-table
            ...
            <el-table-column
                    prop="account_type"
                    :formatter="tableAccountTypeFormatter"
                    label="账户类型">
            </el-table-column>
            <el-table-column
                    prop="cause"
    ...
    export default {
        ...
        data() {
            return {
                ...
                options: {
                    ...
                    deposit_cause_type: dict.report_customer_deposit_cause,
        ...
        methods: {
            ...
            tableCauseTypeFormatter(row, column) {
                return this.options.deposit_cause_type[row[column.property]];
            },
