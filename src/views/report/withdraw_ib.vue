<template xmlns:el-col="http://www.w3.org/1999/html">
    <section>
            ...
            <el-form :inline="true" :model="filters" ref="filters"  size="medium">
                ...
                <el-form-item prop="cause">
                    <el-select clearable  placeholder="资金类型" v-model="filters.cause">
                        ...
                        <el-option :key="value" :label="key" :value="value"
                                   v-for="(key, value) in options.withdraw_cause_type"></el-option>
                    </el-select>
                </el-form-item>
                <el-form-item prop="order_status">
                    <el-select clearable  placeholder="订单状态" v-model="filters.order_status">
                        <el-option key="" label="全部" value=" "></el-option>
                        <el-option :key="value" :label="key" :value="value"
                                   v-for="(key, value) in options.order_status"></el-option>
                    </el-select>
                </el-form-item>
        ...
        <el-table
            ...
            <el-table-column
                    prop="cause"
                    :formatter="tableCauseTypeFormatter"
                    label="资金类型">
            </el-table-column>
            <el-table-column
                    width="120"
...
<script>
    ...
    export default {
        ...
        data() {
            return {
                ...
                options: {
                    ...
                    withdraw_cause_type: dict.report_withdraw_cause,
                    order_status: dict.report_status
                },
                //分页设置
                pager: {
        ...
        methods: {
            ...
            tableAccountTypeFormatter(row, column) {
                return this.options.account_type[row[column.property]];
            },
            tableCauseTypeFormatter(row, column) {
                return this.options.withdraw_cause_type[row[column.property]];
            },
            tableStatusFormatter(row, column) {
                return this.options.order_status[row[column.property]];
            },
