<template>
    <section>
        <el-table :data="items" stripe style="width: 100%"  :header-row-style="headerRowStyle">
            <el-table-column label="返利时间"><template slot-scope="scope"> <span>{{fmtDate(scope.row.rebate_date)}}</span></template> </el-table-column>
    ...
    export default {
        ...
        methods: {
            ...
            fmtDate(time) {
                ...
                return dat.formatDate(date, "yyyy-MM-dd");
            },
        },
        mounted()
        {
