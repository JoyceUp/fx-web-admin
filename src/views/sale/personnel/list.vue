        ...
        <el-col :span="24" class="toolbar" style="padding-bottom: 0px; ">
            ...
            <el-form :inline="true" ref="filters" :model="filters">
                ...
                <el-form-item prop="sales_state">
                    <el-select clearable placeholder="状态" v-model="filters.sales_state">
                ...
                <el-form-item >
                    <el-select clearable placeholder="公司" v-if="companyTree !=''||companyTree.length>0" @change="changeCompany" v-model="positionDic.company">
                        <el-option :key="item.id" :label="item.company_name" :value="item.id" v-for="item in companyTree" ></el-option>
                    </el-select>
                </el-form-item>
                <el-form-item label="" >
                    <el-select clearable placeholder="部门" v-if="departmentTree != ''||departmentTree.length>0" @change="changeDepartmenty" v-model="positionDic.department">
                        <el-option :key="item.id" :label="item.department_name" :value="item.id" v-for="item in departmentTree" ></el-option>
                    </el-select>
                </el-form-item>
                <el-form-item label=""  >
                    <el-select clearable placeholder="组别" v-if="teamTree != ''||teamTree.length>0" v-model="positionDic.team">
                        <el-option :key="item.id" :label="item.team_name" :value="item.id" v-for="item in teamTree" ></el-option>
                    </el-select>
                </el-form-item>
                <el-form-item label="" >
                    <el-select clearable placeholder="职位" v-model="positionDic.position">
                ...
                <el-form-item>
                    <el-button type="danger" @click="$router.push('personnel/add')">新增</el-button>
                </el-form-item>
            </el-form>
        </el-col>
        <!--<el-col :span="24" class="toolbar" style="padding-bottom: 0px; ">-->
