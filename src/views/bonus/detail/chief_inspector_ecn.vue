...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            //查询列表
            getList(start_time, owner_id) {
                if(start_time){
                    this.parents_data.start_time = start_time;
                }
                if(owner_id){
                    this.parents_data.owner_id = owner_id;
                }

                this.listLoading = true;
                let condition = {
                    gmt_create: date.dateStart(this.parents_data.start_time),
                    owner_id: this.parents_data.owner_id,
                ...
                money_api.chiefInspectorRewardECN(params).then((res) => {
