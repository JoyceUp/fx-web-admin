    ...
    export default {
        ...
        methods: {
            ...
            getList(start_time, role_id) {
                ...
                money_api.chiefInspectorRewardStandard(params).then((res) => {
            ...
            salesStateFormatter(row, column) {
                return dict.customer_ib_type[row.sales_state];
            },
            toMoney(row, column) {
