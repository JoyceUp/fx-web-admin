    ...
    <section>
        ...
        <el-col :span="24" class="toolbar" style="padding-bottom: 0px;">
            ...
            <el-form :inline="true" :model="filters" ref="filters" size="medium">
                <el-form-item prop="createDate">
                    ...
                    <!--    <el-date-picker
                        ...
                        <el-date-picker
                                ...
                                start-placeholder="返利日期" end-placeholder="返利日期" placeholder="请选择返佣日期范围"
                                value-format="yyyy-MM-dd">
                        </el-date-picker>
                    </div>
                </el-form-item>
                ...
                <el-form-item prop="role_type">
                    <el-select clearable placeholder="角色" v-model="filters.role_type">
                ...
                <el-form-item prop="belong_sales_account">
                    <el-input
                            placeholder="销售账号"
                            v-model.trim="filters.belong_sales_account">
                    </el-input>
                </el-form-item>
        ...
        <el-table
            ...
            <el-table-column
                    ...
                    label="账户余额(USD)">
                <template slot-scope="scope">
                    <span>{{ div(scope.row.source_account_balance, 100) || 0 }}</span>
                </template>
            </el-table-column>
            <el-table-column
                    width="120"
                    ...
                    label="年化比例">
                <template slot-scope="scope">
                <span>{{ div(scope.row.rate, 10000) || 0 }}%</span>
                </template>
            </el-table-column>
            <el-table-column
                    width="120"
    ...
    export default {
        ...
        methods: {
            ...
            getDepositList() {
                ...
                let condition = {
                    /*start_created_date: date.dateStart(this.filters.date),
                    end_created_date: date.dateEnd(this.filters.date),*/
                    ...
                    belong_sales_account: commons.trimBlank(this.filters.belong_sales_account),
            ...
            exportExcel() {
                ...
                let condition = {
                    start_created_date: date.dateStart(this.filters.date[0]),
                    end_created_date: date.dateEnd(this.filters.date[1]),
                    account_no: this.filters.account_no,
                    role_type: this.filters.role_type,
                    source_account_no: commons.trimBlank(this.filters.source_account_no),
                    source_account_full_name: commons.trimBlank(this.filters.source_account_full_name),
            ...
            tableTypeFormatter(row, column) {
                if(row.bappti_type != undefined && row.bappti_type != null && row.bappti_type != 0) {
