...
export const withdrawExportBankcard = params => {
    return axios.post(`${base}/withdraw/export_bankcard`, params, {responseType: 'arraybuffer'});
};
export const withdrawExportTt = params => {
    return axios.post(`${base}/withdraw/export_tt`, params, {responseType: 'arraybuffer'});
};
...
export const rebateExportOneDay = params => {
    return axios.post(`${base}/rebate/export_one_day`, params);
};
/**
 * 返利列表
 * update by szt 2018.01.31 创建方法
 ...
 *      datas
 * **/
export const internalTransferOfSystemOutIn = params => {
    return axios.post(`${base}/internal_transfer_of_system/out_in`, params);
};