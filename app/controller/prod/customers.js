...
exports.potentials = {
    ...
    info : function (req, res, next) {
        ...
        request.get(`${API.customers.potential_list}/info/$${id}`)
            .query({msg: JSON.stringify(params)})
            .set(header)
            .end(function (req, res) {
                if (res.status === 200) {
...
exports.customers = {
    ...
    address_info : function (_req, _res, next) {
        ...
        request.get(`${API.customers.customer_list}/info/address`)
            .query({msg: JSON.stringify(params)})
            .set(header)
            .end(function (req, res) {
                if (res.status == 200) {
    ...
    update : function (_req, _res, next) {
        ...
        request.put(`${API.customers.customer_list}/info/update_basic`)
    ...
    remove : function (_req, _res, next) {
        ...
        request.delete(`${API.customers.customer_list}/info/remove`)
            .query({msg: JSON.stringify(params)})
            .set(header)
            .end(function (req, res) {
                if (res.status === 200) {
    ...
    tel_transfer : function (_req, _res, next) {
        let header = {
            token: _req.cookies.token
        };
        let {id} = _req.body;
        ...
        request.get(`${API.customers.customer_list}/info/tel_transfer`)
            .query({msg: JSON.stringify(params)})
            .set(header)
            .end(function (req, res) {
                if (res.status === 200) {
